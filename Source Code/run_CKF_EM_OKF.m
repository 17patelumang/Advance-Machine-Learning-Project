...
function [p_vec, loglike, xKAL_learn, xRTS_learn] = run_CKF_EM_OKF(p_init, Y, iter, obsTensor, learnP)
    ...
    for i = 2:iter+1
        ...
        [x_at0, ~, x_pos, x_tot, P_out, ~, ~, P_tot, P_lag] = run_CKF_nUsers_EM_O(p_vec(i-1), Y);
